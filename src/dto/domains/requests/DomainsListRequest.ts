...
export enum DomainsListRequestStatusesItemEnum {
  ACTIVE = "ACTIVE",
  ...
  PENDING_COMPLETE_REDEMPTION_WITHOUT_RECEIPT = "PENDING_COMPLETE_REDEMPTION_WITHOUT_RECEIPT",
  ...
  PENDING_FAILED_REDEMPTION_WITHOUT_RECEIPT = "PENDING_FAILED_REDEMPTION_WITHOUT_RECEIPT",
  PENDING_FAILED_RELEASE_PREMIUM = "PENDING_FAILED_RELEASE_PREMIUM",
  PENDING_FAILED_RENEW_EXPIRATION_PROTECTION = "PENDING_FAILED_RENEW_EXPIRATION_PROTECTION",
  ...
  PENDING_REPORT_REDEMPTION_WITHOUT_RECEIPT = "PENDING_REPORT_REDEMPTION_WITHOUT_RECEIPT",
...
export enum DomainsListRequestStatusGroupsItemEnum {
  INACTIVE = "INACTIVE",
...
export enum DomainsListRequestIncludesItemEnum {
  AUTHCODE = "authCode",
  CONTACTS = "contacts",
  NAMESERVERS = "nameServers",
}

export interface DomainsListRequestParams {
  xShopperId?: string;
  statuses?: Array<DomainsListRequestStatusesItemEnum>;
  statusGroups?: Array<DomainsListRequestStatusGroupsItemEnum>;
  limit?: number;
  marker?: string;
  includes?: Array<DomainsListRequestIncludesItemEnum>;
  modifiedDate?: string;
}

export interface DomainsListRequestPathParams {
  [key: string]: unknown;
}

export interface DomainsListRequestQueryParams {
  [key: string]: unknown;
}

export interface DomainsListRequestHeaders {
  [key: string]: unknown;
}
...
export class DomainsListRequest extends BaseRequestDto {
  ...
  includes?: Array<DomainsListRequestIncludesItemEnum>;
  modifiedDate?: string;
  constructor({ xShopperId, statuses, statusGroups, limit, marker, includes, modifiedDate }: DomainsListRequestParams = {}) {
    super();
  ...
  toPathParams(): DomainsListRequestPathParams {
    return {};
  }
  toQueryParams(): DomainsListRequestQueryParams {
    return {
  ...
  toHeaders(): DomainsListRequestHeaders {
    return {
